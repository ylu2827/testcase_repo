...
public class VirtruAssert {
	...
	public void enterUsername(WebDriver driver) throws InterruptedException
	{
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id=\"identifierId\"]")).sendKeys(myUsername);
	...
	public void assertContent(WebDriver driver) throws InterruptedException
	{
		...
		//List <WebElement> web = driver.findElements(By.xpath("//a[contains(@class,loginButton)]"));
		List <WebElement> web = driver.findElements(By.xpath("//a/div[contains(@data-email,yangautomationtesting)]"));

		System.out.print(web.size());
